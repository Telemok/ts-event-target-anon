 ...
 * @extends EventTarget
 */
export declare class EventTargetAnon extends EventTarget {
    /**
     ...
     */
    addEventListener(type: string, listener: EventListenerOrEventListenerObject | null, options?: boolean | AddEventListenerOptions): Destroy;
}
